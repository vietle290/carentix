          ...
          <div className="p-6 space-y-7">
            ...
            >
              <motion.button
                ...
                onClick={() => router.push(`/search?pickup=${encodeURIComponent(pickup)}&drop=${encodeURIComponent(drop)}&vehicle=${vehicle}&mobile=${encodeURIComponent(mobile)}&pickupLat=${pickUpLat}&pickupLon=${pickUpLon}&dropLat=${dropLat}&dropLon=${dropLon}`)}
