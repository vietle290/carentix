    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <motion.p
          ...
          className="text-white text-md md:text-xl max-w-xl"
        >
          Your ultimate car rental experience. Book your dream car with ease and
          confidence.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          ...
          className="mt-8 flex space-x-6 text-gray-300"
        >
