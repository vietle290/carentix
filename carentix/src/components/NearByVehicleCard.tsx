...
import { ArrowRight, Bike, Car, Clock, Gauge, Package, Star, Truck } from "lucide-react";
...
function NearByVehicleCard({
  ...
  if (vehicle.baseFare && vehicle.pricePerKM && distance) {
    estimated = Math.round(vehicle.baseFare + distance * vehicle.pricePerKM);
  }
  return (
    <motion.div
    ...
    >
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-3 left-3 z-20 flex items-center gap-1 bg-white border border-zinc-200 text-zinc-700 text-[10px] font-bold px-1.5 rounded-full shadow-sm">
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <div className="flex">
              <p className="text-zinc-900 text-sm font-black underline">đ</p>
          ...
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <div className="flex text-zinc-900 text-sm font-black">
              <p className="underline">đ</p>
              <p>{vehicle.waitingCharge}</p>
              <p>/min</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-end justify-between pt-3 border-t border-zinc-100">
          <div>
            ...
            >
              <div className="flex">
                <p className="text-zinc-900 underline font-black">đ</p>
                <p className="text-zinc-900 text-3xl font-black tracking-tight leading-none">
                  {estimated}
                </p>
              </div>
            </motion.div>
...
export default NearByVehicleCard;
