...
function Page() {
  ...
  const getStatusColor = (status: string) => {
    ...
    return color[status] || "bg-gray-50 text-gray-700 border-gray-200";
  };
  ...
  const filterBookings =
    selectedStatus === "All"
      ? bookings
      : bookings.filter(
          (booking) => booking.bookingStatus === selectedStatus.toLowerCase(),
        );
  return (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {!loading && filterBookings.length == 0 && (
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
              ...
              <p className="text-sm text-gray-500 mt-1">
                When you get a booking, it will show up here
              </p>
            </div>
          )}
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-t border-gray-200">
                      ...
                      <div className="flex items-center gap-1 font-semibold text-gray-900">
                        ...
                        <span className="text-lg">{b.fare}</span>
                      </div>
                    </div>
